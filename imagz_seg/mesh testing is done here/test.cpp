...
{
 // Read the image file
 Mat img = imread("test_x50_0.07um_x50_00.png");  //test_x50_0.07um_x50_00.png
...
double min, max;
    ...
    */
    ...
    int borderSize = 50; //75-50 first saved example  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    for(int idx = 0; idx >= 0; idx = hierarchy[idx][0])
    {
        ...
        circle(img, maxLoc, (int)max, Scalar(0, 255, 255), FILLED, 2); //add a circle each time
